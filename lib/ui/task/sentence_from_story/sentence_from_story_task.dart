...
import 'package:Dimik/ui/task/sentence_from_story/sentence_from_story_card.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter/widgets.dart';
import 'package:scoped_model/scoped_model.dart';

class SentenceFromStoryTask extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return SentenceFromStoryState();
  }
}

class SentenceFromStoryState extends State<SentenceFromStoryTask> {
                ...
                : Stack(
                    children: <Widget>[
                      Positioned(
                        ...
                        child: progressDetails(model.sfslist.length),
                      ),
                      Positioned(
                        top: 150,
                        left: 20,
                        ...
                        child: SizedBox(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount: model.sfslist.length >= 10
                                  ? 10
                                  : model.sfslist.length,
                              itemBuilder: (BuildContext context, int index) {
                                return SFSCard(
                                  scaffoldKey: _scaffoldKey,
                                  sfsItem: model.sfslist[index],
                                );
                              },
                            )),
                      ),
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: FlatButton(
                            onPressed: () {
                              setState(() {
                                if (widget.current < model.sfslist.length) {
                                  widget.current++;
                                } else {
                                  model.increment();
