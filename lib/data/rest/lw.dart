...
class LWRest {
  ...
  Future<LWList> getAllLW(String token, int topicId) {
    ...
    print(LISTENING_URL + topicId.toString());
    return _netUtil
        .get(LISTENING_URL + topicId.toString(), headers: headers)
        .then((dynamic res) {
      print("DEBUG :=====================\n" +
          res.toString() +
          "\n=====================\n");
      ...
      lwList = new LWList.fromJson(res);
